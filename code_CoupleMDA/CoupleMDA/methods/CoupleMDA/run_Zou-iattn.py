...
def run_model_Zou(feats_type, hidden_dim, num_heads, attn_vec_dim, rnn_type,
    ...
    net = MAGNN_lp(num_metapaths_list, num_edge_type, etypes_lists, etypes_01,
                   ...
                   use_self_attn=True, meta_mode='node_link', inner_attn=False, self_super_meta=False)
...
if __name__ == '__main__':
    ...
    checkpoint_path = f'checkpoint/checkpoint_{args.dataset}_-iattn_2.pt'
    logfile_path = f"output/output_{args.dataset}_-iattn_2.txt"
    p_data_path = f"pred_data/p_data_{args.dataset}_-iattn_2.csv"
